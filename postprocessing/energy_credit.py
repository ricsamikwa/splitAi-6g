...
def plot_kpis_in_episode(ue_energy_comp_per_algorithm, ue_energy_comm_per_algorithm, flops_offloaded_per_algorithm,
                         y_net_per_algorithm, inference_time_per_algorithm, algorithms):
    """
...
def main():
    ...
    for alg in algorithm:
        ...
        inference_time_per_algorithm[alg] = inference_time_data
    plot_kpis_in_episode(ue_energy_comp_per_algorithm, ue_energy_comm_per_algorithm, flops_offloaded_per_algorithm,
                         y_net_per_algorithm, inference_time_per_algorithm, algorithm)
